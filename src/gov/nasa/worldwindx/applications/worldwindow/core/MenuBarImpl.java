...
import gov.nasa.worldwindx.applications.worldwindow.features.Crosshair;
import gov.nasa.worldwindx.applications.worldwindow.features.FeaturePanel;
import gov.nasa.worldwindx.applications.worldwindow.features.OpenFile;
...
public class MenuBarImpl extends AbstractFeature implements MenuBar
{
    ...
    private static final String[] menuIDs = new String[]
        {
    		Constants.APPLICATION_DISPLAY_NAME,
        };
